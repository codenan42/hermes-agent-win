...
def _load_skill_data(skill_file: Path) -> tuple[bool, str, dict]:
    """Read a SKILL.md once and return compatibility, description, and activation conditions.

    Consolidates I/O and frontmatter parsing to avoid multiple reads/parses per skill.
    Returns (is_compatible, description, conditions).
    """
    try:
