...
def _load_skill_data(skill_file: Path) -> tuple[bool, dict, str, dict]:
    """Load all necessary skill data in a single file read and frontmatter parse.

    Returns (is_compatible, frontmatter, description, conditions).
    On any error, returns (True, {}, "", {}) to err on the side of showing the skill.
    """
    try:
        from tools.skills_tool import _parse_frontmatter, skill_matches_platform

        # Optimized: single read and single frontmatter parse
        ...
        return True, frontmatter, desc, conditions
...
def _parse_skill_file(skill_file: Path) -> tuple[bool, dict, str]:
    ...
    """
    is_compat, frontmatter, desc, _ = _load_skill_data(skill_file)
    return is_compat, frontmatter, desc
...
def build_skills_system_prompt(
    ...
    for skill_file in skills_dir.rglob("SKILL.md"):
        # Optimized: Use _load_skill_data to read file once
