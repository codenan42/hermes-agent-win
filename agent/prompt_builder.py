...
def _load_skill_data(skill_file: Path) -> tuple[bool, dict, str, dict]:
    """Load and parse skill metadata in a single pass.
    ...
    try:
        ...
        # 2. Extract activation conditions
...
def _parse_skill_file(skill_file: Path) -> tuple[bool, dict, str]:
    """Deprecated: Use _load_skill_data for consolidated I/O."""
    is_compat, fm, desc, _ = _load_skill_data(skill_file)
    return is_compat, fm, desc
