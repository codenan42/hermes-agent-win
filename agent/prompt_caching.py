...
def _apply_cache_marker(msg: dict, cache_marker: dict) -> None:
    ...
    if isinstance(content, list) and content:
        # Create a shallow copy of the content list to avoid side effects
        msg["content"] = content[:]
        last = msg["content"][-1]
        if isinstance(last, dict):
            # Create a shallow copy of the content block dictionary
...
def apply_anthropic_cache_control(
    ...
    # Create a shallow copy of the message list
    ...
    # Apply markers to shallow copies of the selected message dictionaries
