...
class TestApplyCacheMarker:
    def test_tool_message_gets_top_level_marker(self):
        ...
        result = _apply_cache_marker(msg, MARKER)
        assert result["cache_control"] == MARKER
    ...
    def test_string_content_wrapped_in_list(self):
        ...
        assert result["content"][0]["cache_control"] == MARKER
        # Ensure original is not mutated
    ...
    def test_list_content_last_item_gets_marker(self):
        ...
        assert result["content"][1]["cache_control"] == MARKER
        # Ensure original is not mutated
