...
# _load_skill_data — single-pass skill file loading
# ---------------------------------------------------------------------------
...
class TestLoadSkillData:
    ...
    def test_returns_conditions_with_fallback_and_requires(self, tmp_path, monkeypatch):
        skill_file = tmp_path / "SKILL.md"
        skill_file.write_text(
            "---\nname: gated\ndescription: Gated skill\n"
            "metadata:\n  hermes:\n    fallback_for_toolsets: [web]\n    requires_tools: [terminal]\n---\n"
        )
        _, _, conditions = _load_skill_data(skill_file)
