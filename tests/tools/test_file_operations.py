...
class TestShellFileOpsPathDenied:
    ...
    def test_write_file_denied_path(self, file_ops):
        ...
        assert ".ssh/authorized_keys" in result.error
    ...
    def test_search_denied_path(self, file_ops):
        # Explicitly make sure _has_command('rg') or _has_command('grep') returns true
        # so we don't get the "requires ripgrep" error instead.
        file_ops._command_cache['rg'] = True
