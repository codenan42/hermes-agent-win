...
class TestPathDenyPrefixes:
    ...
    def test_ssh_exact_prefix_match(self):
        # The directory itself should also be blocked
...
class TestPathAllowed:
    ...
    def test_project_file(self):
        # We can't easily know the real home dir in all test envs, but /tmp is usually safe
