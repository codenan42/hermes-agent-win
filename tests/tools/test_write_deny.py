...
class TestPathDenyPrefixes:
    ...
    def test_ssh_directory_itself(self):
...
class TestPathDenyRobustness:
    def test_none_path(self):
        assert _is_path_denied(None) is True

    def test_defense_in_depth_patterns(self):
        assert _is_path_denied("/var/lib/docker/volumes/foo/_data/.ssh/id_rsa") is True
        assert _is_path_denied("/mnt/data/backup/.hermes/.env") is True
