...
def _apply_move(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    # Block moves involving sensitive paths
    if _is_path_denied(op.file_path):
        return False, f"Move source denied: '{op.file_path}' is a protected system/credential file."
    if _is_path_denied(op.new_path):
        return False, f"Move destination denied: '{op.new_path}' is a protected system/credential file."
