...
def _apply_move(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    from tools.file_operations import _is_path_denied
    if _is_path_denied(op.file_path):
        return False, f"Move denied: '{op.file_path}' is a protected system/credential file (source)."
    if _is_path_denied(op.new_path):
        return False, f"Move denied: '{op.new_path}' is a protected system/credential file (destination)."
