...
def _apply_delete(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    if _is_path_denied(op.file_path):
        return False, f"Permission denied: '{op.file_path}' is protected."
...
def _apply_move(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    if _is_path_denied(op.file_path):
        return False, f"Permission denied (source): '{op.file_path}' is protected."
    if _is_path_denied(op.new_path):
        return False, f"Permission denied (destination): '{op.new_path}' is protected."
