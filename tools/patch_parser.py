...
def _apply_move(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    from tools.file_operations import _is_path_denied
    if _is_path_denied(op.file_path) or _is_path_denied(op.new_path):
        bad_path = op.file_path if _is_path_denied(op.file_path) else op.new_path
        return False, f"Access denied: '{bad_path}' is a protected system/credential file."
