...
def _apply_move(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    # Block moves of sensitive paths
    if _is_path_denied(op.file_path):
        return False, f"Access denied: source '{op.file_path}' is a protected system/credential file."
    if _is_path_denied(op.new_path):
        return False, f"Access denied: destination '{op.new_path}' is a protected system/credential file."
