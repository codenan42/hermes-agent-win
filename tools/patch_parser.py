...
def _apply_delete(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    # Delete using the secure delete_file method
    rm_result = file_ops.delete_file(op.file_path)
    
    if rm_result.error:
        return False, rm_result.error
...
def _apply_move(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    # Use secure move_file method
    mv_result = file_ops.move_file(op.file_path, op.new_path)
    
    if mv_result.error:
        return False, mv_result.error
