...
def _apply_delete(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    # Delete via protected method
    delete_result = file_ops.delete_file(op.file_path)
...
def _apply_move(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    # Move via protected method
    move_result = file_ops.move_file(op.file_path, op.new_path)
