...
def _apply_delete(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    if _is_write_denied(op.file_path):
        return False, f"Write denied: '{op.file_path}' is a protected system/credential file."
...
def _apply_move(op: PatchOperation, file_ops: Any) -> Tuple[bool, str]:
    ...
    from tools.file_operations import _is_write_denied
    if _is_write_denied(op.file_path):
        return False, f"Write denied (source): '{op.file_path}' is a protected system/credential file."
    if _is_write_denied(op.new_path):
        return False, f"Write denied (destination): '{op.new_path}' is a protected system/credential file."
